...
class ConformalRegion:
    def __init__(
        self, traj_path, pred_path, pred_horizon, failure_rate, single_agent=True
    ):
        """
        Args:
    ...
    def _get_conformity_scores(self, t, tau):
        if self.single_agent:
            return self._get_single_agent_nonconformity_scores(t, tau)
        else:
    ...
    def construct_valid_prediction_regions(self, t, tau):
        ...
        nonconformity_scores = self._get_conformity_scores(t, tau)
...
if __name__ == "__main__":
    ...
    t = 10
    tau = 5
    nonconformity_scores = conformal_region._get_single_agent_nonconformity_scores(
        t, tau
    )
